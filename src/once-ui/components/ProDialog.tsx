...
import { Flex, Heading, IconButton, Button, ButtonProps, Text, Grid } from '.';
...
const ProDialog: React.FC<DialogProps> = forwardRef<HTMLDivElement, DialogProps>(({
    isOpen,
    onClose,
    title,
    description,
...
ProDialog.displayName = 'ProDialog';
