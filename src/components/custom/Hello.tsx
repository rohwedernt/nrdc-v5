          ...
          <Flex className={styles.wrapper} style={{ width: '100%' }}>
            <Flex direction="column" justifyContent='center' fillWidth style={{ flex: 1 }}>
              <div className={styles.textContainer}>
                <Text className={styles.text} variant="body-default-s" align='center' style={{ fontStyle: 'italic', paddingBottom: '1rem', paddingTop: '1rem', color: '#d2d2dc' }}>Former developer - part-time process nerd - full-time advocate for teams that work well and care deeply - lifelong believer that the best engineering cultures are the ones that value both high standards and high trust.</Text>
                ...
                <Text className={styles.text} variant="body-default-s">I've led teams across the stack, coached engineers of all levels through growth, helped rewrite platforms without (completely) breaking everything, worked side by side with product and design teams, overhauled hiring systems and helped organizations find clarity in chaos.</Text>
