          ...
          <Flex className={styles.wrapper} gap="s" direction="row" alignItems="center" fillWidth>
            <Flex direction="column" justifyContent='center' fillWidth>
              <div className={styles.textContainer}>
                <Text className={styles.text} variant="body-default-s">I'm a software engineering leader who believes that great teams build great systems—and that good management is about more than just process and delivery. It's about coaching real human beings to grow, thrive, and do the best work of their lives.</Text>
                ...
                <Text className={styles.text} variant="body-default-s" align='center' style={{ fontStyle: 'italic', paddingBottom: '1rem', paddingTop: '1rem' }}>Former developer - part-time process nerd - full-time advocate for teams that work well and care deeply - life-long believer that the best engineering cultures are the ones that value both high standards and high trust.</Text>
